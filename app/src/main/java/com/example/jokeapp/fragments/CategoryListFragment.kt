...
import com.example.jokeapp.adapters.CharactersAdapter
...
class CategoryListFragment : Fragment(), Callback<CharactersResponse>,
    ...
    override fun onResponse(call: Call<CharactersResponse>, response: Response<CharactersResponse>) {
        ...
        if (response.isSuccessful) {
            ...
            val charactersList = handleCharactersResponse(charactersResponse)
            if (charactersList.isNotEmpty()) {
                with((binding.categoriesRecyclerView.adapter as CharactersAdapter)) {
                    submitList(charactersList)
                    setOnCharacterClickListener(this@CategoryListFragment)
                }
            }
        } else {
            Snackbar.make(
    ...
    private fun handleCharactersResponse(charactersResponse: CharactersResponse?): List<CharactersResponse.Character> {
